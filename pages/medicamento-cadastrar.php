<div class="container">
    <div class="row">
        ...
        <div class="col mt-2">
            <label class="form-label" for="material">Medicamento</label>
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" placeholder="Medicamento" aria-label="Medicamento" aria-describedby="basic-addon1" name="medicamento" id="medicamento">
            </div>
        </div>
        <div class="col mt-2">
            <label class="form-label" for="pesologia">Posologia</label>
            <div class="input-group mb-3">
                <span class="input-group-text" id="basic-addon1">
                ...
                <input type="text" class="form-control" placeholder="Posologia" aria-label="Posologia" aria-describedby="basic-addon1" name="posologia" id="posologia">
            </div>
        </div>
    </div>
    <div class="row">
