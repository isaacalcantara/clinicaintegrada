    ...
    <div class='row'>
        ...
        <div class='col mt-2'>
            ...
            <div class='input-group mb-3'>
                ...
                <input type='text' class='form-control' placeholder='Material' aria-label='Material' aria-describedby='basic-addon1' name='material' id='material'>
            </div>
        </div>
        <div class='col mt-2'>
            ...
            <div class='input-group mb-3'>
                ...
                <input type='number' min='1' class='form-control' placeholder='Quantidade' aria-label='Quantidade' aria-describedby='basic-addon1' name='quantidade' id='quantidade'>
            </div>
        </div>
        <div class='col mt-2'>
            ...
            <div class='input-group mb-3'>
                ...
                <input type='text' min='1' class='form-control' placeholder='Custo' aria-label='Custo' aria-describedby='basic-addon1' name='custo' id='custo'>
            </div>
        </div>
    </div>
    <div class='row'>
