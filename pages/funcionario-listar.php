...
$sql = "SELECT * FROM funcionario AS f
    INNER JOIN cargo AS c ON id = f.cargo_id";
...
print "<div class='tab-pane fade show active' id='funcionario-tab-pane' role='tabpanel' aria-labelledby='cargo-tab' tabindex='0'>";
                        print "<table class='table table-striped'>";
                           ...
                           print "<div class='row mt-1'>";
                                ...
                                print "</div>";
                                print "<a class='dropdown-item' href='?page=funcionario-cadastrar'>";
                            ...
                            while($row = $res->fetch_object()){
                              print "<tr>";
                                ...
                                print "<td>".ExibeData($row->birthdate_funcionario)."</td>";
                                print "<td class='d-flex justify-content-end p-3'>";
                                    ...
                                    print "<button class='btn btn-danger me-1'>
